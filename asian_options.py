...
def asian_options(params, paths):
    ...
    print(f"Asian arithmetic average call price by Monte Carlo Discounted): {price_call:.6f}")
    print(f"Asian arithmetic average put price by Monte Carlo Discounted): {price_put:.6f}")
...
def main():
    ...
    call, put = asian_options(params, paths)

    asian_option_price_visualization(params, call, put)
